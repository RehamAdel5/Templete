using Application.Handeler.CQRS.AboutUs.Queries;
using Application.Handeler.CQRS.AskedQuestion.Queries;
using Application.Handeler.CQRS.ContactUs.Queries;
using Application.Handeler.CQRS.Features.Queries;
using Application.Handeler.CQRS.HorizontalSlider.Queries;
using Application.Handeler.CQRS.Project.Queries;
using Application.Handeler.CQRS.Service.Queries;
using Application.Handeler.CQRS.Skills.Queries;
using Application.Handeler.CQRS.Team.Queries;
using Application.Handeler.CQRS.Testimonial.Queries;
using Application.Handeler.CQRS.WhyUs.Queries;
